...
def partition (lista, inicio, fim, ordem):
    ...
    while True:
        ...
        if len(ordem) == 2:
            ...
            while i < j and lista[i][ordem[0]] == pivot[ordem[0]] and \
            ...
            while i < j and lista[j][ordem[0]] == pivot[ordem[0]] and \
        ...
        if len(ordem) == 3:
            ...
            while i < j and lista[i][ordem[1]] == pivot[ordem[1]] and \
            ...
            while i < j and lista[j][ordem[1]] == pivot[ordem[1]] and \
