...
def partition (lista, inicio, fim, ordem):
    ...
    if len(ordem) == 1:
        while True:
            ...
            while i < j and lista[i] <= pivot: i = i + 1
            if i < j:
                lista[i], lista[j] = pivot, lista[i]
                # lista[j] é maior que o pivô
                j = j - 1
            else: break
            # Diminuindo j
            while i < j and lista[j] >= pivot: j = j - 1
            if i < j:
                lista[i], lista[j] = lista[j], pivot
                # lista [i] é maior que o pivô
                i = i + 1
            else: break
        return i
        ...
        #while i < j:
                ...
                #else:
                    #break
            #elif lista[i][ordem[0]] == pivot[ordem[0]] and len(ordem) == 1:
                #i = i + 1
                #if i < j:
                    #lista[i], lista[j] = pivot, lista[i]
                    #j = j - 1
            ...
            #if lista[i][ordem[0]] == pivot[ordem[0]] and len(ordem) == 2:
                    ...
                    #else:
                        #break
                #elif lista[i][ordem[1]] == pivot[ordem[1]]:
                    #break

            #if lista[i][ordem[0]] == pivot[ordem[0]] and len(ordem) == 3:
                #if lista[i][ordem[1]] < pivot[ordem[1]]:
                    #i = i + 1
                    #if i < j:
                        #lista[i], lista[j] = pivot, lista[i]
                        ...
                        #break
                #elif lista[i][ordem[1]] == pivot[ordem[1]]:
                    #if lista[i][ordem[2]] < pivot[ordem[2]]:
                        #i = i + 1
                        #if i < j:
                            #lista[i], lista[j] = pivot, lista[i]
                            #j = j-1
            ...
            #while i < j:
                    ...
                    #j = j + 1
                        ...
                        #else:
                            #break
                    #elif lista[j][ordem[1]] == pivot[ordem[1]]:
                        #break
